...
<footer class="bg-[#1A3770] text-white/60 border-t border-white/10">
	...
	<div class="border-t border-white/10 max-w-7xl mx-auto px-6 py-2 text-center">
		<p class="text-white/30 text-[8px] leading-relaxed">
		...
		<p class="text-white/30 text-[8px] leading-relaxed mt-1.5">
	...
	<div class="border-t border-white/10 max-w-7xl mx-auto px-6 py-1.5 flex flex-col sm:flex-row items-center justify-between gap-2 text-[10px] text-white/40">
