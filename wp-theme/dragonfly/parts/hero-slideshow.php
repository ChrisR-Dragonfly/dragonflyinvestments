...
<section class="bg-[#f7f8fa] px-6">
	<div class="relative h-[calc(100dvh-240px)] min-h-[420px] flex items-center overflow-hidden rounded border border-[#dddddd] shadow-sm max-w-7xl mx-auto" data-dfi-slideshow>
		...
		<div class="relative z-20 px-8 md:px-14 py-16">
			<p class="text-[#C8961A] text-xs font-semibold uppercase tracking-[0.3em] mb-6">Miami, Florida &middot; Est. 2013</p>
			<h1 class="text-4xl md:text-6xl font-bold text-white leading-tight max-w-3xl mb-8">
				Over 50 Years of Combined Real Estate <span class="text-[#C8961A]">Experience</span>
			</h1>
			<p class="text-white/80 text-lg md:text-xl max-w-2xl leading-relaxed mb-12">
			...
			<div class="flex flex-wrap gap-4">
				<a href="<?php echo esc_url( dfi_url( '/portfolio/' ) ); ?>" class="px-8 py-4 bg-white text-[#1A3770] font-bold text-sm uppercase tracking-widest rounded hover:bg-[#f0f0f0] transition-colors">View Portfolio</a>
				<a href="<?php echo esc_url( dfi_url( '/contact/' ) . '#contact-form' ); ?>" class="px-8 py-4 border-2 border-[#C8961A] text-white font-bold text-sm uppercase tracking-widest rounded hover:bg-[#C8961A] transition-colors">Contact Us</a>
			</div>
		</div>
	</div>
</section>
